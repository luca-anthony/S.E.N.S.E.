...
What this device does does is when your hand is fully extended it turns on and through sensors on the palm of the glove, starts measuring the distance between your hand an an object or thing near you.\
If it is within a certain threshold it will start to vibrate.

The reason we wanted to make this is because a lot of blind people struggle with getting around or even just reaching for things without knocking them over.\
This helps by letting you know when you may be just a bit too close to something.

There are two modes, one for just getting around that has a greater threshold or one with a smaller threshold, for if you are going to be grabbing cups, things on a desk, or just trying to organize.
